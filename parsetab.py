...
_lr_productions = [
  ...
  ('program -> K_PROGRAM ID LCURLY program_body RCURLY','program',5,'p_program','yaccf23.py',15),
  ('program_body -> program_body program_body','program_body',2,'p_program_body','yaccf23.py',22),
  ('program_body -> function','program_body',1,'p_program_body_fp','yaccf23.py',26),
  ('program_body -> procedure','program_body',1,'p_program_body_fp','yaccf23.py',27),
  ('program_body -> epsilon','program_body',1,'p_program_body_empty','yaccf23.py',31),
  ('function -> K_FUNCTION K_INTEGER ID LPAREN RPAREN LCURLY statements RCURLY','function',8,'p_function','yaccf23.py',35),
  ('procedure -> K_PROCEDURE ID LPAREN parameter_list RPAREN LCURLY statements RCURLY','procedure',8,'p_procedure','yaccf23.py',41),
  ('parameter_list -> parameter_list COMMA parameter','parameter_list',3,'p_parameter_list','yaccf23.py',47),
  ('parameter_list -> parameter','parameter_list',1,'p_parameter_list','yaccf23.py',48),
  ('parameter -> K_INTEGER ID','parameter',2,'p_parameter','yaccf23.py',55),
  ('parameter -> K_DOUBLE ID','parameter',2,'p_parameter','yaccf23.py',56),
  ('parameter -> K_STRING ID','parameter',2,'p_parameter','yaccf23.py',57),
  ('parameter -> epsilon','parameter',1,'p_parameter_empty','yaccf23.py',62),
  ('statements -> statements statements','statements',2,'p_statements','yaccf23.py',67),
  ('statements -> declare','statements',1,'p_statements_dapf','yaccf23.py',71),
  ('statements -> assign','statements',1,'p_statements_dapf','yaccf23.py',72),
  ('statements -> print','statements',1,'p_statements_dapf','yaccf23.py',73),
  ('statements -> function_call','statements',1,'p_statements_dapf','yaccf23.py',74),
  ('statements -> epsilon','statements',1,'p_statements_empty','yaccf23.py',78),
  ('declare -> K_INTEGER ID SEMI','declare',3,'p_declare','yaccf23.py',82),
  ('declare -> K_DOUBLE ID SEMI','declare',3,'p_declare','yaccf23.py',83),
  ('assign -> ID ASSIGN ICONSTANT SEMI','assign',4,'p_assign','yaccf23.py',88),
  ('assign -> ID ASSIGN DCONSTANT SEMI','assign',4,'p_assign','yaccf23.py',89),
  ('assign -> ID ASSIGN SCONSTANT SEMI','assign',4,'p_assign','yaccf23.py',90),
  ('assign -> ID ASSIGN math SEMI','assign',4,'p_assign','yaccf23.py',91),
  ('print -> K_PRINT_INTEGER LPAREN ID RPAREN SEMI','print',5,'p_print','yaccf23.py',100),
  ('print -> K_PRINT_STRING LPAREN SCONSTANT RPAREN SEMI','print',5,'p_print','yaccf23.py',101),
  ('print -> K_PRINT_STRING LPAREN ID RPAREN SEMI','print',5,'p_print','yaccf23.py',102),
  ('print -> K_PRINT_DOUBLE LPAREN ID RPAREN SEMI','print',5,'p_print','yaccf23.py',103),
  ('function_call -> ID LPAREN ID RPAREN SEMI','function_call',5,'p_function_call','yaccf23.py',107),
  ('math -> expression','math',1,'p_math','yaccf23.py',111),
  ('expression -> expression PLUS term','expression',3,'p_expression','yaccf23.py',115),
  ('expression -> expression MINUS term','expression',3,'p_expression','yaccf23.py',116),
  ('expression -> term','expression',1,'p_expression_term','yaccf23.py',125),
  ('term -> term TIMES factor','term',3,'p_term','yaccf23.py',129),
  ('term -> term DIVIDE factor','term',3,'p_term','yaccf23.py',130),
  ('term -> factor','term',1,'p_term_factor','yaccf23.py',138),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expr','yaccf23.py',142),
  ('factor -> MINUS LPAREN expression RPAREN','factor',4,'p_factor_expr','yaccf23.py',143),
  ('factor -> ICONSTANT','factor',1,'p_factor_num','yaccf23.py',154),
  ('factor -> DCONSTANT','factor',1,'p_factor_num','yaccf23.py',155),
  ('factor -> ID','factor',1,'p_factor_id','yaccf23.py',159),
  ('epsilon -> <empty>','epsilon',0,'p_epsilon','yaccf23.py',166),
]
